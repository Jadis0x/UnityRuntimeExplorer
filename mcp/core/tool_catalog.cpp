...
const nlohmann::json& read_only_catalog() {
    static const nlohmann::json tools = nlohmann::json::array({
        ...
        tool("start_instance_scan", "Start instance scan",
             "Start a bounded, time-sliced search for live instances of a managed type. UnityEngine.Object types use a direct engine query; ordinary managed types traverse static managed roots and never enumerate every Unity object.",
        ...
        tool("get_instance_scan", "Get instance scan",
             ...
             schema({{"scan_reference", {{"type", "string"}, {"minLength", 1}, {"maxLength", 128}}},
                     ...
                     {"limit", {{"type", "integer"}, {"minimum", 1}, {"maximum", 100}}}},
                    {"scan_reference"})),
        tool("cancel_instance_scan", "Cancel instance scan",
             "Cancel an active managed instance scan and release its queued roots. Does not modify game state.",
             schema({{"scan_reference", {{"type", "string"}, {"minLength", 1}, {"maxLength", 128}}}},
                    {"scan_reference"}), true, false),
        ...
        tool("inspect_type", "Inspect managed type", "Return bounded field, property, and method metadata for an opaque type reference.",
             schema({{"type_reference", {{"type", "string"}, {"minLength", 1}, {"maxLength", 128}}},
                     ...
                     {"member_limit", {{"type", "integer"}, {"minimum", 1}, {"maximum", 250}}}},
                    {"type_reference"})),
        tool("list_method_traces", "List method traces", "List active and retained method trace sessions without exposing native addresses; consecutive identical calls are reported as collapsed groups.", schema()),
        tool("get_method_trace", "Get method trace", "Read bounded decoded calls from a method trace session, including sequence ranges and repeat counts for collapsed groups.",
